...
const (
	...
	PostHeatingEnabled  byte = 0x07		// bit 5 = Post heating, i.e. 0x20=enable, 0=disable
...
var registerMap = map[byte]mapFn{
	...
	TempTargetInside:       valueToTemp,
	TempPostHeating:        valueToTemp,
	TempHexBypass:          valueToTemp,
